...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ImageButton speakerButton = findViewById(R.id.matchEmotionsSpeakerButton);
    ...
    void generateView(List<String> photosList) {
        TextView txt = findViewById(R.id.rightEmotion);
        ...
        LinearLayout linearLayout1 = findViewById(R.id.imageGallery);
...
//                startActivityForResult(i, 2);
    ...
    boolean checkCorrectness() {
        return wrongAnswersSublevel <= l.getCorrectness();
    }
    ...
    */
    String selectPhotoWithSelectedEmotion() {
        ...
        return photosWithEmotionSelected.get(photoWithSelectedEmotionIndex);
    }
        ...
        if (l.getTimeLimit() != 0) {
            timer = new CountDownTimer(l.getTimeLimit() * 1000, 1000) {
                ...
                public void onFinish() {
                    LinearLayout imagesLinear = findViewById(R.id.imageGallery);
