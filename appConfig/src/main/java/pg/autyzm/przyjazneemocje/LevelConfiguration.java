...
public class LevelConfiguration extends AppCompatActivity implements View.OnClickListener {
    ...
    void loadLevel(int value) {
        ...
        EditText timeLimit = findViewById(R.id.time_limit);
        EditText vpPerLevel = findViewById(R.id.pv_per_level);
        EditText correctness = findViewById(R.id.correctness);
        EditText sublevels = findViewById(R.id.sublevels);
        EditText levelName = findViewById(R.id.level_name);
...
//        TextView tv = (TextView) findViewById(R.id.imagesCount);
    ...
    public void addLevel(View view) {
        ...
        if (levelValidator.validateLevel()) {
            sqlm.addLevel(l);
            final TextView msg = findViewById(R.id.saveMessage);
...
//
    ...
    private void updateListSize() {
        TextView tv = findViewById(R.id.imagesCount);
